...
// 리팩터링을 하며 초가된 코드 덕분에 전체 로직을 구성하는 요소 각각이 더 뚜렷이 부각되고,
// 계산하는 부분과 출력 형식을 다루는 부분을 분리함
// 이렇게 모듈화하면 각 부분이 하는 일과 그 부분들이 맞물려 돌아가는 과정을 파악하기 쉬워짐

// 📌 간결함이 지혜의 정숭리지 몰라도, 프로그래밍에서만큼은 명료함이 진화할 수 있는 소프트웨어의 정수다
...
// 리팩터링 작업을 통해 개선점을 코드에 반영하는 식으로 진행한다.
